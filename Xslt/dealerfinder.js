                        ...
                        if (results.length > 0) {
                            ...
                            jQuery.each(results, function(k, v) {
                                ...
                                if (v.getAttribute("fax") != "") {
                                    phoneFax += "<div><span>Email:</span> " + v.getAttribute("fax") + "</div>";
                                }
                                ...
                                if (number > 9) {
                                    $("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit' />")
                                        .html("<div class='name'>" + lang[currCulture].name + v.getAttribute("name") + "</div><div class='address'><span class='mdi mdi-map-marker'></span><p>" + lang[currCulture].address + ': ' + v.getAttribute("address") + "</p></div><div class='email'> <span class='mdi mdi-email'></span><p>" +"<a href='mailto:" + v.getAttribute("fax") + "'>" + v.getAttribute("fax") + "</a></p></div><div class='phone'><span class='mdi mdi-phone'></span><p>" + "<a href='tel:" + v.getAttribute("phone") + "'>" + v.getAttribute("phone") + "</a></p></div></li>")
                                        .click(function() {
									...
									$("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit' />")
									.html("<div class='name'>" + lang[currCulture].name + v.getAttribute("name") + "</div><div class='address'><span class='mdi mdi-map-marker'></span><p>" + lang[currCulture].address + ': ' + v.getAttribute("address") + "</p></div><div class='email'> <span class='mdi mdi-email'></span><p>" + "<a href='mailto:" + v.getAttribute("fax") + "'>" + v.getAttribute("fax") + "</a></p></div><div class='phone'><span class='mdi mdi-phone'></span><p>" + "<a href='tel:" + v.getAttribute("phone") + "'>" + v.getAttribute("phone") + "</a></div></li>")
                                        .click(function() {
                                            //displayPoint(marker, i);
                                            infowindow.setContent(info_window_string);
                                            infowindow.open(map, marker);
...
function info_window_content(v) {
    ...
    if (v.getAttribute("fax") != null && v.getAttribute("fax") != '') {
        info_window_string += "<p class='fax'><span>Email:</span> " + v.getAttribute("fax") + "</p>";
    }
