  ...
  <xsl:template match="/">
          ...
          <table class="table order-table">
            <tbody>
              ...
              <tr class="billing-phone">
                <td>
                  <span>
                     <xsl:value-of select="/ShoppingCart/NumberPhoneText"></xsl:value-of><xsl:text>:</xsl:text>
                  </span>
                </td>
                <td>
    ...
    <section class="minicart clearfix">
      ...
      <div class="carttable clearfix">
        ...
        <section class="group">
          <div class="label">
            <xsl:value-of select="/ShoppingCart/DiscountText"></xsl:value-of>
          </div>
            ...
            <xsl:choose>
              <xsl:when test="/ShoppingCart/CouponCode!=''">
                <div class="discount-total coupon-input">
                  <div class="summary-total">
                    <span class="title"><xsl:value-of select="/ShoppingCart/CodeUsedText"></xsl:value-of>:</span>
              ...
              <xsl:otherwise>
                <div class="coupon-input">
                  <span class="title"><xsl:value-of select="/ShoppingCart/PromotionCodeText"></xsl:value-of>:</span>
                  <div class="form-group">
        ...
        <xsl:if test="/ShoppingCart/PointIsAvailable='true'">
          <section class="group spending-points">
            <div class="label">
              <xsl:value-of select="/ShoppingCart/PointsOfUseText"></xsl:value-of>:
            </div>
